...
namespace win {
    ...
    using DRIVER_ADD_DEVICE = ntstatus(struct DRIVER_OBJECT* DriverObject, struct DEVICE_OBJECT* PhysicalDeviceObject);
    ...
    using DRIVER_DISPATCH = ntstatus(DEVICE_OBJECT* DeviceObject, IRP* Irp);

    using DRIVER_INITIALIZE = ntstatus(DRIVER_OBJECT* DriverObject, UNICODE_STRING* RegistryPath);

    using DRIVER_STARTIO = ntstatus(DRIVER_OBJECT* DriverObject, UNICODE_STRING* RegistryPath);

    using DRIVER_UNLOAD = ntstatus(DRIVER_OBJECT* DriverObject);
