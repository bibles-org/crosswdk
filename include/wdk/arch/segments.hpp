...
namespace arch {
    ...
    struct segment_selector : crosswdk::utils::bits16 {
        ...
        constexpr auto requestor_privilege_level(this auto&& self) noexcept {
            return self[requestor_privilege_level_];
        }

        constexpr auto table(this auto&& self) noexcept {
            return self[table_];
        }

        constexpr auto index(this auto&& self) noexcept {
            return self[index_];
        }
    };
